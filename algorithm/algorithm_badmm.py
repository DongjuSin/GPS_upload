...
class AlgorithmBADMM(Algorithm):
    ...
    def iteration(self, itr, sample_lists):
        """
        ...
        for inner_itr in range(self._hyperparams['inner_iterations']):
            ...
            ## dongju : to save covariacne of local controller
            cntr_cov = [
                self.cur[cond].traj_distr.pol_covar for cond in range(self.M)
            ]
            np.save('/hdd/gps-master/plot_control_cov/controller_covar.npy', cntr_cov)
            self._update_trajectories(itr)
