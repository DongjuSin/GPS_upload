...
from gps.algorithm.cost.config import COST_LOG
from gps.algorithm.cost.cost import Cost
from gps.algorithm.cost.cost_utils import evallogl2term, get_ramp_multiplier


class CostLog(Cost):
    """ Computes l1/l2 distance to a fixed target state. """
    def __init__(self, hyperparams):
        config = copy.deepcopy(COST_LOG)
