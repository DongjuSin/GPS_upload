...
class PolicyOptTf(PolicyOpt):
    ...
    def __init__(self, hyperparams, dO, dU):
        ...
        # pretrain_path = os.path.join('/hdd/gps-master/python/gps/pre_train/policy_opt/tf_checkpoint/old', 'policy_checkpoint_pre_training_0.ckpt')
        # reader = pywrap_tensorflow.NewCheckpointReader(pretrain_path)
        ...
        ## dongju : initilize network with pretrained weights
        # self.restore_pretrain_weights()

    def init_network(self):
        """ Helper method to initialize the tf networks used """
        print 'policy_opt_tf: init_netowrk is called'
    ...
    def restore_pretrain_weights(self):
        ## function for restoring pretrained weights
        print '\nresotore_pretrain_weights is called'
        
        restore_list = ['conv_params/wc1:0', 'conv_params/wc2:0', 'conv_params/wc3:0',
                        'conv_params/bc1:0', 'conv_params/bc2:0', 'conv_params/bc3:0']
        trainable_vars = tf.trainable_variables()
        vars_to_restore = [var for var in trainable_vars if var.name in restore_list]
        
        saver_pretrain = tf.train.Saver(vars_to_restore)
        saver_pretrain.restore(self.sess, '/hdd/gps-master/python/gps/nn_only/pretrain_model_epoch_199.ckpt')
    ...
    def __setstate__(self, state):
        print 'policy_opt_tf: __setstate__ is called'
