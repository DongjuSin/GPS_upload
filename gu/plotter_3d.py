...
class Plotter3D:
    ...
    def plot(self, i, xs, ys, zs, linestyle='-', linewidth=1.0, marker=None,
        ...
        ## dongju: explicitly set axis limit
        # self._axarr[i].set_xlim(xlim[0], xlim[1])
        # self._axarr[i].set_ylim(ylim[0], ylim[1])
        # self._axarr[i].set_zlim(zlim[0], zlim[1])
        self._axarr[i].set_xlim(0.5, 1.0)
        self._axarr[i].set_ylim(-0.25, 0.05)
        self._axarr[i].set_zlim(-0.15, 0.1)
        self._axarr[i].set_xlabel('x (m)')
        self._axarr[i].set_ylabel('y (m)')
        self._axarr[i].set_zlabel('z (m)')
        self._axarr[i].set_aspect('equal')
