...
exp_name = 'baxter_kiro'
itr = int(sys.argv[1])
num_cond = 1

initial = np.array([0.6946574174171344, -0.2712848433478493])
target = np.array([[0.7294122551543994, 0.037921935844682106], [0.8150253200518949, 0.047917090887082785]])
